...
from mbs.scripts.finetuner_base import FinetunerBase, FinetuneArgs
from mbs.models import generate_model, Backbone
from mbs.models import SegResNetOutput
...
def main():
    from mbs.datasets.tiantan.load import load_cohort
    # conf = get_conf()
