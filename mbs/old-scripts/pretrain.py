...
from mbs.models import generate_model
from mbs.scripts.runner_base import RunnerBase
...
class Pretrainer(RunnerBase):
    ...
    def prepare_data(self):
        from mbs.datasets.brats21 import load_all
...
def get_loader(dataset) -> Callable[[Namespace], MultimodalDataset]:
    from mbs import datasets as datasets
    loader = {
